        ...
        <div class="md:col-span-2 bg-white rounded-2xl border border-gray-100 shadow-sm p-7 flex flex-col justify-between">
            <div>
                ...
                <p class="text-sm text-gray-500 leading-relaxed">
                    Halaman FAQ ini membantu perusahaan memahami cara kerja TemuAksi — mulai dari meninjau proposal, pendanaan, hingga laporan kegiatan.
                </p>
                ...
                <div class="mt-6 space-y-2.5">
                    ...
                    <div class="flex items-center gap-2.5 text-sm text-gray-500">
                        ...
                        Informasi proposal & pendanaan CSR
                    </div>
                    <div class="flex items-center gap-2.5 text-sm text-gray-500">
                        <svg class="w-4 h-4 text-blue-400 flex-shrink-0" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" d="M5 13l4 4L19 7"/>
    ...
    >
        ...
        >
            <div class="flex justify-between items-center mb-6">
                ...
                <button type="button" @click="openFaqForm = false" class="w-8 h-8 rounded-full bg-gray-100 hover:bg-gray-200 flex items-center justify-center transition-colors">
            ...
            <form action="{{ route('perusahaan.faq.store') }}" method="POST" class="space-y-4">
                @csrf
                <div>
                ...
                <div>
                    <label class="block text-sm font-medium text-gray-700 mb-1.5">
                        Detail <span class="text-gray-400 font-normal">(opsional)</span>
                    </label>
                ...
                <div class="flex justify-end gap-3 pt-2">
                    <button type="button" @click="openFaqForm = false"
