...
<section class="max-w-7xl mx-auto px-6 py-10">
    ...
    <div class="mb-8">
        ...
        <p class="text-gray-500 ml-[52px]">Temukan peluang volunteer yang sesuai dengan minat dan kemampuanmu.</p>
    </div>
                ...
                <div class="relative h-48 overflow-hidden">
                    ...
                    <div class="absolute top-3 left-3">
                        <span class="text-xs font-medium px-2.5 py-1 rounded-full
                            ...
                            @elseif($kegiatan->status == 'penuh') bg-amber-100 text-amber-700
                            @elseif($kegiatan->status == 'selesai') bg-blue-100 text-blue-700
